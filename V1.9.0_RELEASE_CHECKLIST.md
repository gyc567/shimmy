...
- [ ] Measure vision inference time (CPU): Record baseline
- [ ] Measure vision inference time (GPU CUDA): Compare to CPU
- [ ] Measure vision inference time (GPU Vulkan): Compare to CUDA
- [ ] Measure vision inference time (MLX): Compare to others
